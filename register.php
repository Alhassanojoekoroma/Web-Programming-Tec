...
<head>
  ...
  <title>Register — Street Bull</title>
...
<body>
  ...
  <main style="padding-top:140px; display:flex; justify-content:center; padding-bottom:60px;">
    <div
      style="width:420px; background:#fff; padding:32px; border-radius:12px; box-shadow:0 8px 24px rgba(0,0,0,0.08);">
      <h2 style="margin-top:0; color:var(--navy);">Create an account</h2>
      <form id="register-form">
        ...
        <div style="margin-bottom:24px;">
          ...
          <select name="role" style="width:100%; padding:12px; border-radius:8px; border:1px solid #ddd;">
      ...
      <p style="margin-top:16px; font-size:14px; text-align:center;">
        Already have an account? <a href="login.php"
          style="color:var(--orange); text-decoration:none; font-weight:600;">Login</a>
      </p>
    </div>
  </main>
